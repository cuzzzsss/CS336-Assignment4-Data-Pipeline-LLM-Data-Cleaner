...
# Handle each file
handle_file "dolma_fasttext_nsfw_jigsaw_model.bin" "https://hf-mirror.com/allenai/dolma-jigsaw-fasttext-bigrams-nsfw/resolve/main/model.bin"
handle_file "dolma_fasttext_hatespeech_jigsaw_model.bin" "https://hf-mirror.com/allenai/dolma-jigsaw-fasttext-bigrams-hatespeech/resolve/main/model.bin"